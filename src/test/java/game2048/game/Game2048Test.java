...
import static game2048.game.Game2048.GAME_SIZE;
...
class Game2048Test {
    ...
    void gameTest() {
        var game = new Game2048();
        Board<Key, String> b2 = new SquareBoard<>(2);
        b2.fillBoard(List.of("hello", "hi"));
        ...
        Board<String, Double> b3 = new Board<>(1,1) {
            ...
            @Override
            public List<Double> getValueRow(int i) {
                return null;
            }

            @Override
            public List<Double> getValueColumn(int i) {
                return null;
            }
        };
